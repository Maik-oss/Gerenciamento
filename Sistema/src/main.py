...
from src.negocio.login_service import LoginService
from src.negocio.usuarios_service import UsuarioService
...
def principal() -> None:
    ...
    repositorio_usuario = UsuariosRepository(conexao)
    servico_login = LoginService(repositorio_usuario)
    servico_usuario = UsuarioService(repositorio_usuario)
    ...
    gui = SistemaGUI(
        ...
        servico_login=servico_login,
        servico_usuario=servico_usuario,
    )
